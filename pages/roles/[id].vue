  ...
  <div>
    <v-card class="pa-4 my-4">
      ...
      <v-container>
        ...
        <v-data-table v-model="selected" :headers="headers" :items="permissionsData.data" class="m-4 p-4 elevation-1"
          :loading="loading" :search="search" show-select return-object item-value="id">
        </v-data-table>
